...
function aktipesan4(){
  wallpaper.style="transform: scale(1.5);";kalimat.innerHTML=pesan4.innerHTML + " ❤️";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
}
...
afterComplete: function(){
  pesan7.innerHTML=vketik7;fungsi=1;
},}).go();
}
//Pemisah
